...
<body>
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <button type="submit"><i class="fa-solid fa-user-plus"></i>&nbsp Ajouter Formation</button>
        </form>

        <div class="hrefs">
            <div class="btn"><a href="gestion_formation.php">Retour à la liste des formations</a></div>
            <p>ou</p>
            <div class="btn"><a href="dashboard_formation.php">Retour au dashboard</a></div>
        </div>
    </div>
