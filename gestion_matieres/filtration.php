...
.container {
    ...
    background-image: linear-gradient(147deg, #166d3b 30%, #000000 100%);
...
<body>
    <div class="container">
    <a href="http://localhost/IFTTS/gestion_formation/dashboard_formation.php" class="return"><i class="fa-solid fa-arrow-left"></i>&nbsp Return to dashboard</a>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <select id="niveau" name="niveau">
                ...
                $sql_niveau = "SELECT DISTINCT niveau FROM programme_formation";
    ...
    <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($result_filter->num_rows > 0) {
                ...
                echo "<table border='1'>";
                echo "<tr><th>Unité de Formation</th><th>Niveau</th><th>VH 1ère Année</th><th>VH 2ème Année</th><th>Coefficient</th><th>Designation</th></tr>";
