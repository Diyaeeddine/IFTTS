        ...
        <form action="Update_formateur.php" method="POST">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="mb-3 form-floating">
                        <input type="tel" id="telephone" name="telephone" class="form-control" placeholder=" "
                ...
                <div class="col-sm-6">
                    ...
                    <div class="mb-3 form-floating">
                        <input type="text" id="diplome_re" name="diplome_re" class="form-control" placeholder=" "
                            value="<?php echo $diplome_re ?>">
                        <label for="diplome_re" class="form-label">Diplôme Re</label>
                    </div>

                    <div class="mb-3 form-floating">
                        <input type="text" id="diplome_acces" name="diplome_accees" class="form-control" placeholder=" "
                            value="<?php echo $diplome_acces ?>">
                    ...
                    <div>
                        <button type="submit" class="btn btn-primary w-100 p-2 mb-5 fs-5">Appliquer les
...
elseif (!isset($_GET['CIN']) or $_GET['CIN'] == '') 
    {
